                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        ...
                        <table width="100%" cellpadding="10" cellspacing="0" id="mai">
                            ...
                            <tr>
                                <td><a href="allresult.php" class="link-button">Back</a></td>
                                <td>
                                    <select name="course">
                        ...
                        <div id="show">
                            <table width="100%" cellpadding="10" cellspacing="0" id="payrec" class="res">
                            
                            <tr>
                                <th>Name</th><th>CA1</th><th>CA2</th><th>CA</th><th>EXAM</th><th>TOTAL</th><th>GRADE</th>
                            </tr>
                            <tr align="center">
                                <td>Ajibade, Taiwo</td>
                                <td><input type="text" value="0" name="ca1[]"/></td>
                                <td><input type="text" value="0" name="ca2[]"/></td>
                                <td><span style="color: #cb5432">20</span></td>
                                <td><input type="text" value="0" name="exam[]"/></td>
