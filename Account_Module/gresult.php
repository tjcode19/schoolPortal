...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Admin Module :: Generate Result</title>
    ...
    //callback handler for select change of option for state
      ...
      var c1 = c.replace(" ", "%20");
       ...
       $("#content").load("../bin_admin/result_gen.php?page=1&sid="+ c1, hideLoader());       
	...
	showLoader();
	$("#content").load("../bin_admin/result_gen.php?page=1", hideLoader);
});
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        ...
                        <div id="mai" style="margin-bottom: 10px;">
                            ...
                            <input type="text" name="sid" id="sid" placeholder="Enter Student ID"/>
