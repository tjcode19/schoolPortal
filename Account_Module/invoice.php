...
<html class="no-js">
    <head>
        <meta charset="utf-8"/>
        <title>School portal :: Admin Module :: Invoice</title>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                showLoader();
                $("#content").load("../bin_bursar/invoice_list.php", hideLoader());

                
        
                $('.search_invoice').submit(function (e) {
                    $('#loading-img').css('display', 'inline');
                    var cl = $("#cla").val();
                    var tr = $("#term").val();
                    var se = $("#session").val();
                    var st = $("#status").val();
                    $("#content").load("../bin_bursar/invoice_list.php?cl=" + cl + "&tr=" + tr + "&se=" + se + "&st=" + st);
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">	
                        <div id="mai" style="margin-bottom: 10px;">
                            ...
                            <form action="" method="post" id="cs" class="search_invoice"> 	
                                ...
                                <select name="status" id="status">
                                    ...
                                    <?php
                                    $log->set_sqlstr("SELECT * FROM invoice_status");
                                    $log->querydata();
                                    for ($i = 0; $i < $log->no_rec; $i++) {
                                        echo "<option value=\"" . $log->data[0] . "\">" . $log->data[1] . "</option>";
                                        $log->fetchdata();
                        ...
                        <hr/> 
                        <div id="mai" style="margin-bottom: 10px;">
                            <a class="link-button">Pay All</a> <a class="link-button">Generate All</a> 
                        </div>
                        <hr/> 
                        <div id="content">
