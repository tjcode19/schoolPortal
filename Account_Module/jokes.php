...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Admin Module :: Jokes</title>
		...
		<script type="text/javascript">
                    $(document).ready(function(){
                     ...
                     $("#paging_button ul li").click(function(){
                            ...
                            $("#content").load("../bin_admin/jokes.php?page=" + this.id, hideLoader);
                    ...
                    showLoader();
                    $("#content").load("../bin_admin/jokes.php?page=1",hideLoader());
	...
	<body class="blog">
	 <?php
        ...
        $per_page = 20;  
        $log->set_sqlstr("select * from publications WHERE Type='Jokes' ");
        $log->querydata(); 
        $count = $log->no_rec;
