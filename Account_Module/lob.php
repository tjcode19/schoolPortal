...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School portal :: Admin Module :: List Of Book</title>
	...
	function hideLoader(){
      ...
      var c1 = c.replace(" ", "%20");
      //alert(c1+s1+t1);
       $("#content").load("../bin_admin/lob_view.php?page=1&c="+ c1, hideLoader()); 
	...
	$("#content").load("../bin_admin/lob_view.php", hideLoader);
});
