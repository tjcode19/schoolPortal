...
<html class="no-js">
	...
	$("#content").load("../bin_bursar/paylog.php?page=1", hideLoader);
      ...
      showLoader();
      var c = $("#sid").val();
	  var lnk = "calpay.php?class="+c;
      $("a#vacct").attr("href",lnk);
      $("#content").load("../bin_bursar/paylog.php?page=1&sid="+ c, hideLoader());
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        ...
                        <div id="mai" style="margin-bottom: 10px;">
							...
							<a target="_blank" href="#" class="link-button" id="vacct">View Account Details</a>
                            </form>
                        </div>
                            <div id="content">
