...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Admin Module :: Publications</title>
		...
		<script type="text/javascript">
                    ...
                    $("#article").load("../bin_admin/article.php?page=1");
                    $("#jokes").load("../bin_admin/jokes.php?page=1");
                    $("#quote").load("../bin_admin/quote.php?page=1");
                    $("#news").load("../bin_admin/news.php?page=1",hideLoader());
