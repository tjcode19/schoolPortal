...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Admin Module :: Quotes</title>
		...
		<script type="text/javascript">
                    $(document).ready(function(){
                     ...
                     $("#paging_button ul li").click(function(){
                            ...
                            $("#content").load("../bin_admin/quote.php?page=" + this.id, hideLoader);
                    ...
                    showLoader();
                    $("#content").load("../bin_admin/quote.php?page=1",hideLoader());
