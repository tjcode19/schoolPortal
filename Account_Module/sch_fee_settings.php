...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School portal :: Admin Module :: School Fee Settings</title>
	...
	showLoader();
	$("#content").load("../bin_bursar/settings_show.php", hideLoader());
	
		
	 $('.search_fee').submit(function(e){
		$('#loading-img').css('display','inline');
		var cl = $("#cla").val();
		var tr = $("#term").val();
		var se = $("#session").val();
		$("#content").load("../bin_bursar/settings_show.php?cl="+cl+"&tr="+tr+"&se="+se); 		
		$('#adds').attr("href","../bin_bursar/settings_edit.php?cl="+cl+"&tr="+tr+"&se="+se);
            ...
            <div class="wrapper cf">
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">	
							...
							<form action="" method="post" id="cs" class="search_fee">
