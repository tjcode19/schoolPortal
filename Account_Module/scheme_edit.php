...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Admin Module :: Scheme Of Work</title>
	...
	function hideLoader(){
      ...
      var t1 = t.replace(" ", "%20");
      //alert(c1+s1+t1);
       $("#content").load("../bin_admin/scheme_edit.php?page=1&c="+ c1 +"&s="+ s1 +"&t="+ t1, hideLoader()); 
	...
	$("#content").load("../bin_admin/scheme_edit.php?page=1", hideLoader);
});
