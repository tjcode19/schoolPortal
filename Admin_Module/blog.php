...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Demo School :: Admin Module :: Blog</title>
	        	...
	        	<div id="posts-list" class="cf">        	
                            ...
                            <article class="format-quote">
                                    <div class="box cf">
                                            ...
                                            <div class="excerpt">
                                                    <a href="single.php?id=1" class="post-heading" >Death doesn't really worry me that much, I'm not frightened about it... I just don't want to be there when it happens</a>
                            ...
                            <article class="format-standard">
                                    ...
                                    <div class="box cf">
                                            ...
                                            <div class="excerpt">
                                                    <a href="single.php" class="post-heading" >LOREM IPSUM DOLOR AMET</a>
                                                    ...
                                                    <p><a href="single.php" class="learnmore">Learn More</a></p>
                                            </div>
