...
<html class="no-js">
	...
	function hideLoader(){
      ...
      $("#content").load("../bin_admin/calpayment.php?t="+term+"&s="+ sess, hideLoader());
                        ...
                        <div id="mai" style="margin-bottom: 10px;">
                            <form action="" method="post" id="calp">
                                    <select name="term" id="term">
                                        ...
                                        <?php 
                                        $log->set_sqlstr("SELECT DISTINCT Term FROM payment_log WHERE Class ='".$_REQUEST['class']."'"); 
                                        $log->querydata();                        
                                    ...
                                    <select name="sess" id="sess">
                                        ...
                                        <?php 
                                        $log->set_sqlstr("SELECT DISTINCT Session FROM payment_log WHERE Class ='".$_REQUEST['class']."'"); 
                                        $log->querydata();                        
                                        for($i=0; $i < $log->no_rec; $i++){
                                           echo "<option value=\"".$log->data[0]."\">".$log->data[0]."</option>"; 
                                           $log->fetchdata();
