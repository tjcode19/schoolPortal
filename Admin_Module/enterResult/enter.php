    ...
    <body id="resultpage"> 
        <div id="mainp">
            ...
            <form action="display.php" method="post">
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-success" href="<?php echo Admin_Module; ?>enterResult?c=<?php echo $_REQUEST['c']; ?>">Show All Students </a>
            ...
            <table width="100%" cellpadding="5" cellspacing="0" border="1">
                ...
                <tr>
                    ...
                    <?php 
                        for($b=0; $b<$no_subject; $b++){
                        $log1->set_sqlstr("SELECT * FROM result WHERE term=".$term." AND session=".$sess." AND subject=".$_POST['subject'][$b]." AND student_id='".$log->data[0]."'");
                        $log1->querydata();
                    ?>
                        <td>
