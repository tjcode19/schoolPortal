...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal:: Admin Module :: Result Log</title>
	...
	function hideLoader(){
       ...
       $('#sid').change(function(e) {
        showLoader();
        var c = $("select#sid").val();
         //$("#sid").hide();
         $("#content").load("../bin_admin/editRes.php?c="+ c, hideLoader());
     ...
     //callback handler for select change of option for state
      ...
      if(act == 1){
        ...
        $.ajax(
        {
            url : "../bin_admin/update_result.php",
            type: "POST",
            data : postData,
            dataType: 'json',
            success:function(d)
            {
                ...
                alert("Data Updated");
                $("#content").load("../bin_admin/result_edit.php?page=1&act=1&c="+ c1 +"&s="+ s1 +"&t="+ t1 +"&se="+ se1, hideLoader()); 
            },
        ...
        var se1 = se.replace(" ", "%20");
        //var act = $("input#act").val();
       $("#content").load("../bin_admin/result_edit.php?page=1&act=2&c="+ c1 +"&t="+ t1 +"&s="+ s1 +"&se="+ se1, hideLoader());
      }
	...
	showLoader();
	$("#content").load("../bin_admin/result_edit.php?page=1", hideLoader);
});
