...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Admin Module :: News</title>
		...
		<script type="text/javascript">
                    $(document).ready(function(){
                     ...
                     $("#paging_button ul li").click(function(){
                            ...
                            $("#content").load("../bin_admin/news.php?page=" + this.id, hideLoader);
                    ...
                    showLoader();
                    $("#content").load("../bin_admin/news.php?page=1",hideLoader());
	...
	<body class="blog">
	 <?php
        ...
        $per_page = 20;  
        $log->set_sqlstr("select * from publications WHERE type=1");
        $log->querydata(); 
        $count = $log->no_rec;
