...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Admin Module :: Post Joke</title>
      ...
      showLoader();
       ...
       //$("#sid").hide();
		...
		bkLib.onDomLoaded(function() {
			myeditor = new nicEditor({fullPanel : true}).panelInstance('content1');
		});
		
		function toggleditor() {
			myeditor.removeInstance('content1');
			myeditor = null;
			myeditor = new nicEditor({fullPanel : true}).panelInstance('content1');
		}
					...
					<fieldset>
                                                ...
                                                <p>
                                                        <select name="type" id="type">
															...
															<?php 
															$log->set_sqlstr("SELECT * FROM publicationstype"); 
															$log->querydata();                        
						...
						<p>
							<textarea  name="content1"  id="content1" rows="5" cols="5" class="form-poshytip" placeholder="Enter content here" title="Enter content here"></textarea>
						</p>
												
						<p><input type="submit" value="Send" name="submit" id="submit" onClick="toggleditor();"/> 
					</fieldset>
