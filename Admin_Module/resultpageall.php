    ...
    <body id="resultpage">
        ...
        <header>
            ...
            <table width="100%" cellpadding="5" cellspacing="0" id="s">
                ...
                ?>
                    <tr align="center">
                        <td><?php echo $rs->data['subject']; ?></td>
            ...
            <table width="100%" cellpadding="5" cellspacing="0" id="s">
                ...
                ?>
                    <tr align="center">
                        ...
                        <td><?php echo $rs->data['exam']; ?></td>
                        <td><?php $t = ($ca + $rs->data['exam']); echo ($t<40)?"<span style=\"color:red\">".$t."</span>":$t ?></td>
						<td><?php echo getCourseAve($log->data[0], $_REQUEST['se'], $_REQUEST['t'], $_REQUEST['c'], $rs->data['subject']); ?></td>
            ...
            <div id="row2">
                <div id="act">
                 <?php
					...
					$log1->set_sqlstr("SELECT * FROM behaviouralattitude WHERE student_id='".$log->data[0]."' AND term='".$_REQUEST['t']."' AND session='".$_REQUEST['se']."'");
                    $log1->querydata();
                ...
                ?>
                    ...
                    <tr>
                        <td>Politeness</td><td><?php echo Grad($log1->data[5]); ?></td>
                    </tr>
                    <tr>
                        <td>Punctuality</td><td><?php echo Grad($log1->data[6]); ?></td>
                    </tr>
                    <tr>
                        <td>Neatness </td><td><?php echo Grad($log1->data[7]); ?></td>
                    </tr>
                    <tr>
                        <td>Relationship with Student</td><td><?php echo Grad($log1->data[8]); ?></td>
                    </tr>
                    <tr>
                        <td>Relationship with Staff</td><td><?php echo Grad($log1->data[9]); ?></td>
                    </tr>
                    <tr>
                        <td>Initiative</td><td><?php echo Grad($log1->data[10]); ?></td>
                    </tr>
                    <tr>
                        <td>Emotional Stability</td><td><?php echo Grad($log1->data[11]); ?></td>
                    </tr>
                    <tr>
                        <td>Sociality</td><td><?php echo Grad($log1->data[12]); ?></td>
                    </tr>
                    <tr>
                        <td>Attentiveness </td><td><?php echo Grad($log1->data[13]); ?></td>
                    </tr>
                    <tr>
                        <td>Attendance</td><td><?php echo Grad($log1->data[14]); ?></td>
                    </tr>
                    <tr>
                        <td>Others</td><td><?php echo Grad($log1->data[15]); ?></td>
                    </tr>
                </table>
                </div>
                 <?php
