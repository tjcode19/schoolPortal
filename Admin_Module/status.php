...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Admin Module :: Status & Eligibility</title>
	...
	showLoader();
	$("#content").load("../bin_admin/student_s_list.php?page=1", hideLoader);
      ...
      var c = $("#sid").val();
      var d = c.replace(" ", "%20");
      $("#content").load("../bin_admin/student_s_list.php?page=1&sid="+ d, hideLoader());
