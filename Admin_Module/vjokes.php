...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Demo School :: Admin Module :: Views Jokes</title>
	...
	$("#adds").click(function(){
		...
		$("#content").load("../bin/jokes_list.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin/jokes_list.php?page=1", hideLoader);
});
    ...
    <body class="page">
        <?php
            $per_page = 20;  
            $log->set_sqlstr("select * from publications WHERE Type='Jokes' AND Status=0");
            $log->querydata(); 
            $count = $log->no_rec;
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        ...
                        <div id="content">
                            ...
                            <tr>
                                <th>S/N</th><th>Title</th><th>Joke</th><th>Status</th><th></th>
                            </tr>
                            <tr align="center">
                                <td>1.</td>
                                <td>Drop me at Benin</td>
                                <td>"I want to drop at benin..."</td>
                                <td>Hidden</td>
                                <td>
                                    <a href="v_result.php?n=SD2012002">
                                        <img class="alignleft" alt="Read" title="Read Joke" src="../img/mono-icons/paper32.png" />
                                    </a>
                                    <a href="v_result.php?n=SD2012002">
                                        <img class="alignleft" alt="Approve" title="Approve Joke" src="../img/mono-icons/check32.png" />
                                    </a>
                                    <a href="v_result.php?n=SD2012002">
                                        <img class="alignleft" alt="Delete" title="Delete Joke" src="../img/mono-icons/stop32.png" />
                                    </a>
                                </td>
                            </tr>
