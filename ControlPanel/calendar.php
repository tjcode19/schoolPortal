...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Demo School :: Control Panel :: School Calendar</title>
	...
	showLoader();
	$("#content").load("../bin_cpanel/cal_view.php?page=1", hideLoader);
      ...
      var c = $("#sid").val();
      var d = c.replace(" ", "%20");
      $("#content").load("../bin_cpanel/cal_view.php?page=1&sid="+ d, hideLoader());
            ...
            <div class="wrapper cf">
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        <a class="link-button" href="../bin_cpanel/cal_edit.php" style="margin-bottom: 10px;" id="adds">Update Calendar</a><hr/>
                        <div id="content">
                        </div>
                    </div>
                    <!-- ENDS entry content -->
