...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Control Panel :: Class List</title>
	...
	function hideLoader(){
		...
		$("#content").load("../bin_cpanel/class_list.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin_cpanel/class_list.php?page=1", hideLoader);
      ...
      var c = $("#sid").val();
      var d = c.replace(" ", "%20");
      $("#content").load("../bin_cpanel/class_list.php?page=1&sid="+ d, hideLoader());
