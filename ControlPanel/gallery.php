...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Demo School :: Control Panel :: Photo Gallery</title>
       ...
       $("#show").load("../bin_cpanel/uploadpic_ph.php",hideLoader());
	...
	$("#adds").click(function(){
		...
		$("#content").load("../bin_cpanel/photo.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin_cpanel/photo.php?page=1", hideLoader);
});
