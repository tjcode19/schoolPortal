...
<html class="no-js">
    ...
    //callback handler for select change of option for state
      ...
      showLoader();
        ...
        $.ajax(
        {
            url : "../includes/generatepin.inc.php",
            type: "POST",
            data : postData,
            //dataType: 'json',
            dataType: 'html',
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        <form id="mai" action="" method="post">
                                <fieldset>
                                        <p>
                                                <input name="Qty"  id="Qty" type="text" class="form-poshytip" placeholder="Enter the Quantity" title="Enter the Quantity" />
                                        </p>

                                       
                                        <p><input type="submit" value="Generate PIN" name="submit" id="submit" /> 
                                </fieldset>
