...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Control Panel :: Personal Data</title>
	...
	showLoader();
	$("#content_home").load("../bin_cpanel/control_home.php?page=1", hideLoader);
});
...
function editpix(us){
             //showLoader();
             //var link = this.href; 
               $("#show").load("../bin/uploadpic1.php?user=" + us );
               $("#mwindow").show();
               $("#paging_button").show();
               //hideLoader();
	};
