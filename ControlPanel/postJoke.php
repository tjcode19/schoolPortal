...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Demo School :: Admin Module :: Post Joke</title>
			...
			<div class="wrapper cf">
				...
				<form id="mai" action="" method="post">
					<fieldset>
						...
						<p>
							<input name="title"  id="title" type="text" class="form-poshytip" placeholder="Enter the Title of the Joke" />
						</p>
                                                
                                                <p>
							<input name="author"  id="author" type="text" class="form-poshytip" placeholder="Enter the Author of the Joke" />
						</p>
						
						<p>
							<textarea  name="joke"  id="joke" rows="5" cols="10" class="form-poshytip" placeholder="Enter your joke here"></textarea>
						</p>
