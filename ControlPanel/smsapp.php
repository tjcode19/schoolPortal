...
<html class="no-js">
	...
	function hideLoader(){
        ...
        //Call to Add SMS Unit
	$('#add_unit').click(function(e) {
            showLoader();
            var unit=prompt("Please enter Unit","");
            if (unit!=null && unit!="")
              {
                $.ajax(
                {
                    url : "../bin_cpanel/send_sms.php?event=add_u&amt= " + unit,
                    success:function(d){$(".bal").html(d, hideLoader());}
                });
              }
              else{
                hideLoader();
        ...
        //Call to Subtract SMS Unit
	$('#sub_unit').click(function(e) {
            showLoader();
            var unit=prompt("Please enter Unit","");
            if (unit!=null && unit!="")
              {
                $.ajax(
                {
                url : "../bin_cpanel/send_sms.php?event=sub_u&amt= " + unit,
                success:function(d){$(".bal").html(d, hideLoader());}
                });
              }
              else{
       ...
       $('#mai').submit(function(e) {
        ...
        $.ajax(
        {
            ...
            success:function(d)
            {
                ...
                //$("#content").load("../bin/lob_view.php?page=1&c="+ c1, hideLoader()); 
            },
			...
			<div class="wrapper cf">
	        	...
	        	<div id="posts-list" class="cf">        	
	        		  <div class="search-background">
                           ...
                           <!-- form -->
                                <a href="" id="add_unit" class="link-button green">Add Unit</a>
                                <a href="" id="sub_unit" class="link-button red">Subtract Unit</a><hr/>
