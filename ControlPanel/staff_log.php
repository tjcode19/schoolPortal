...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal:: Control Panel :: Staff Log</title>
	...
	$("#adds").click(function(){
		...
		$("#content").load("../bin_cpanel/staff_list.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin_cpanel/staff_list.php?page=1", hideLoader);
});
...
$per_page = 20;  
$log->set_sqlstr("select * from authentication WHERE priority=2");
$log->querydata(); 
$count = $log->no_rec;
                ...
                <div id="page-content-sb" class="cf">
                    ...
                    <div class="entry-content cf">
                        ...
                        <div id="mai" style="margin-bottom: 10px;">
                            ...
                            <input type="button" value="Add New Staff" id="adds"/>
                            <input type="text" name="sid" id="sid" value="" Placeholder="Search..."/>
							<span>Total Staff: <?php echo $log->no_rec; ?></span>
                            </form>
                        </div>
                        <div id="content">
...
$(document).ready(function(){
    ...
    //callback handler for select change of option for state
      ...
      var d = c.replace(" ", "%20");
     //alert(d);
       $("#content").load("../bin/staff_list.php?page=1&sid="+ d, hideLoader()); 
