...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Control Panel :: Student Log</title>
	...
	$("#adds").click(function(){
		...
		$("#content").load("../bin_cpanel/student_list.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin_cpanel/student_list.php?page=1", hideLoader);
});
                ...
                <div id="page-content-sb" class="cf">        	
                    ...
                    <div class="entry-content cf">
                        ...
                        <div id="mai" style="margin-bottom: 10px;">
							...
							<span>Total Students: <?php echo $log->no_rec; ?></span>
                            </form>							
                        </div>
                        <div id="content">
...
$(document).ready(function(){
    ...
    //callback handler for select change of option for state
      ...
      var d = c.replace(" ", "%20");
      //alert(d);
       $("#content").load("../bin_cpanel/student_list.php?page=1&sid="+ d, hideLoader());
