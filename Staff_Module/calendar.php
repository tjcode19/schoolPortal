...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Staff Module :: School Calendar</title>
	...
	showLoader();
	$("#content").load("../bin_staff/cal_view.php?page=1", hideLoader);
      ...
      var c = $("#sid").val();
      var d = c.replace(" ", "%20");
      $("#content").load("../bin_staff/cal_view.php?page=1&sid="+ d, hideLoader());
