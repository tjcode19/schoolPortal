...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Staff Module :: Class List</title>
	...
	function hideLoader(){
		...
		$("#content").load("../bin_staff/class_list1.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin_staff/class_list1.php?page=1", hideLoader);
	...
	/*
        $per_page = 20;  
        $log->set_sqlstr("select * from status WHERE Class='".$cla."'");
        $log->querydata(); 
        $count = $log->no_rec;
