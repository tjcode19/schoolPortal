...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal:: Staff Module :: Employment Details</title>
       ...
       //$("#show").load("../bin/emp_det.php",hideLoader());
	...
	showLoader();
	$("#content_emp").load("../bin_staff/emp_det_sta.php?page=1", hideLoader);
});
