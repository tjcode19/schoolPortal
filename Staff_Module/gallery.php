...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Demo School :: Staff Module :: Photo Gallery</title>
       ...
       $("#show").load("../bin/uploadpic_ph.php",hideLoader());
	...
	$("#adds").click(function(){
		...
		$("#content").load("../bin/photo.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin/photo.php?page=1", hideLoader);
});
