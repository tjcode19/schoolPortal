...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Staff Module :: Personal Data</title>
	...
	function hideLoader(){
		...
		$("#content_home").load("../bin_staff/staff_list.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content_home").load("../bin_staff/staff_home.php?page=1", hideLoader);
});
...
function editpix(us){
             //showLoader();
             //var link = this.href; 
               $("#show").load("../bin_staff/uploadpic2.php?user=" + us );
               $("#mwindow").show();
               $("#paging_button").show();
               //hideLoader();
	};
