...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Staff Module :: List Of Book</title>
	...
	function hideLoader(){
      ...
      $('#sea').change(function(e) {
      showLoader();
      var c = $("select#cl").val();
      var c1 = c.replace(" ", "%20");
      //alert(c1+s1+t1);
       $("#content").load("../bin_staff/lob_view.php?page=1&c="+ c1, hideLoader()); 
	...
	$("#content").load("../bin_staff/lob_view1.php", hideLoader);
});
