...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Demo School :: Staff Module :: Post Joke</title>
				...
				<form id="contactForm" action="#" method="post">
					<fieldset>
						...
						<p>
							...
							<input name="name"  id="name" type="text" class="form-poshytip" title="Enter the Title of the Joke" />
						</p>
						
						<p>
							<label for="joke">Joke</label>
							<textarea  name="joke"  id="joke" rows="5" cols="10" class="form-poshytip" title="Enter your joke here"></textarea>
						</p>
