...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Staff Module :: Publications</title>
		...
		<script type="text/javascript">
                    ...
                    $("#article").load("../bin_staff/article1.php?page=1");
                    $("#jokes").load("../bin_staff/jokes1.php?page=1");
                    $("#quote").load("../bin_staff/quote1.php?page=1");
                    $("#news").load("../bin_staff/news1.php?page=1",hideLoader());
	...
	<body class="blog">
	 <?php
        ...
        $per_page = 20;  
        $log->set_sqlstr("select * from publications WHERE Status=1");
        $log->querydata(); 
        $count = $log->no_rec;
