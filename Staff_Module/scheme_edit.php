...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Staff Module :: Edit Scheme Of Work</title>
	...
	function hideLoader(){
      ...
      var t1 = t.replace(" ", "%20");
      //alert(c1+s1+t1);
       $("#content").load("../bin_staff/scheme_edit.php?page=1&c="+ c1 +"&s="+ s1 +"&t="+ t1, hideLoader()); 
      ...
      showLoader();
        ...
        $.ajax(
        {
            ...
            success:function(d)
            {
                ...
                var t1 = t.replace(" ", "%20");
                alert("Data Updated");
                $("#content").load("../bin_staff/scheme_list.php?page=1&c="+ c1 +"&s="+ s1 +"&t="+ t1, hideLoader()); 
            },
	...
	$("#content").load("../bin_staff/scheme_edit.php?page=1", hideLoader);
});
                       ...
                       <div class="search-background">
                        ...
                        <div id="mai" style="margin-bottom: 10px;">
                             <form action="" method="post" id="sea">
                                    <input type="hidden" name="cl" id="cl" value="<?php echo $cla; ?>"/>
