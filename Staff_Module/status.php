...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Staff Module :: Status & Eligibility</title>
	...
	function hideLoader(){
		...
		$("#content").load("../bin_staff/student_s_list1.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("../bin_staff/student_s_list1.php?page=1", hideLoader);
    ...
    <body class="page">
         <?php
            ...
            $per_page = 20;  
            $log->set_sqlstr("select * from behaviouralattitude WHERE Class='".$cla."'");
            $log->querydata(); 
            $count = $log->no_rec;
