...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Demo School :: Staff Module :: Submit Article</title>
				...
				<form id="contactForm" action="#" method="post">
					<fieldset>
						...
						<p>
							...
							<input name="name"  id="name" type="text" class="form-poshytip" title="Enter the Title of the Article" />
						</p>
                                                <p>
							<label for="au" >Author</label>
							<input name="au"  id="au" type="text" class="form-poshytip" title="Enter the Author of the Article" />
						</p>
						
						<p>
							<label for="article">Article</label>
							<textarea  name="article"  id="article" rows="5" cols="10" class="form-poshytip" title="Enter your joke here"></textarea>
						</p>
