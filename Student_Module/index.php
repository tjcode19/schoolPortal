...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Student Module :: Personal Data</title>
	...
	showLoader();
	$("#content_home").load("../bin_student/student_home.php?page=1", hideLoader);
});
        ...
        <div id="main">
            <div class="wrapper cf">
                ...
                <div id="page-content-sb" class="cf">        	
					<span><marquee scrollamount="5" scrolldelay="3">Welcome <?php echo $_SESSION['name']; ?></marquee></span>
                    <!-- entry-content -->	
