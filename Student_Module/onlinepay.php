<?php 
 ...
 $log->set_sqlstr("SELECT amount FROM paymentlog WHERE student_id='".$_SESSION['s_portal_id']."' AND term='".$term."' AND session='".$sess."'"); 
 $log->querydata();
 $deposit = "";
 ...
 $log->set_sqlstr("SELECT Amount FROM schoolfees WHERE class='".$class."'"); 
 $log->querydata();
 $amt = $log->data[0];
...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Student Module :: Online Payment</title>
                    ...
                    <div class="entry-content cf">
                         <div id="col1">
                            <table width="100%" cellpadding="10" cellspacing="0">
                                ...
                                <tr>
                                    <td align="right">School Fee:</td><td>NGN <?php echo addcomma($amt); ?></td>
                                </tr>
                                 <tr>
                                    <td align="right">Deposit:</td><td> NGN <?php echo addcomma($deposit); ?></td>
                                </tr>
                                <tr>
                                    <td align="right">Balance:</td><td>NGN <?php echo addcomma($bal); ?></td>
                                </tr>
                            </table>
                        </div>
                        <h3 class="payrec">Pay with Naira MasterCard</h3>
                         <table width="100%" cellpadding="10" cellspacing="0" id="mai">
                            
                            <tr>
                                <td><input type="text" class="form-poshytip" value="" name="amt" placeholder="Enter Amount" Title="Enter Amount Here"/>
                                </td>
                                <td>
