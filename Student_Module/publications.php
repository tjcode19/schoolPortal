...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>School Portal :: Student Module :: Publications</title>
		...
		<script type="text/javascript">
                    ...
                    $("#article").load("../bin_student/article1.php?page=1");
                    $("#jokes").load("../bin_student/jokes1.php?page=1");
                    $("#quote").load("../bin_student/quote1.php?page=1");
                    $("#news").load("../bin_student/news1.php?page=1",hideLoader());
