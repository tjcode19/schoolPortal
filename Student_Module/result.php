...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Student Module :: Result Log</title>
    ...
    //callback handler for select change of option for state
      ...
      var se1 = se.replace(" ", "%20");
       ...
       $("#content").load("../bin_student/result_view1.php?page=1&act=2&t="+ t1 +"&se="+ se1, hideLoader());       
        e.preventDefault(); //STOP default action
    });
        
	showLoader();
	$("#content").load("../bin_student/result_view.php?page=1", hideLoader);
});
