...
<html>
    ...
    <body id="resultpage"> 
        ...
        <header>
            <div id="logo_res">
                <img  src="../img/banner.png" alt="Simpler">
            </div>
            <div id="row1">
            ...
            <table width="100%" cellpadding="5" cellspacing="0" id="s">
                ...
                <?php
                    $log->set_sqlstr("SELECT * FROM result WHERE student_id='".$_REQUEST['id']."' AND term='".$_REQUEST['t']."' AND session='".$_REQUEST['se']."' ORDER BY subject ASC");
                    $log->querydata();
                    function Grade($g){
                        return (($g >= 70)?"A":
                                (($g < 70 && $g >= 60)?"B":
