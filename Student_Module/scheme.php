...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>School Portal :: Student Module :: Scheme Of Work</title>
	...
	function hideLoader(){
      ...
      var t1 = t.replace(" ", "%20");
      //alert(c1+s1+t1);
       $("#content").load("../bin_student/scheme_list1.php?page=1&c="+ c +"&s="+ s +"&t="+ t, hideLoader()); 
             e.preventDefault(); //STOP default action
    });
        
	showLoader();
	$("#content").load("../bin_student/scheme_list1.php?page=1", hideLoader);
});
