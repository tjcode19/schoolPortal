    ...
    <table width="100%" cellpadding="10" cellspacing="0" id="det">
         <tr>
            <td colspan="3">
                ...
                <a href="../bin/adm_e_det.php?n=<?php echo $log->data['Username']; ?>" id="edit">Edit</a>
                 <?php echo (($status == 'Active')?
                        "<a href=\"../bin/adm_v_det.php?a=deactivate&n=". $log->data['Username'] ."\" id=\"deactivate\">Deactivate</a>":
                        "<a href=\"../bin/adm_v_det.php?a=activate&n=". $log->data['Username'] ."\" id=\"activate\">Activate</a>"); ?>
                <a href="../bin/adm_v_det.php?a=reset&n=<?php echo $log->data['Username']; ?>" id="reset">Reset Password</a>
            </td>
        </tr>
        <tr>
...
function editpix(us){
             //showLoader();
             //var link = this.href; 
               $("#show").load("../bin/uploadpicad.php?user=" + us +"&name=" + us);
               $("#mwindow").show();
               $("#paging_button").show();
               //hideLoader();
	};
