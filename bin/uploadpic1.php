...
function afterSuccess()
{
	...
	$('#loading-img').hide(); //hide submit button
        ...
        $("#content_emp").load("../bin/emp_det.php"); 
        $("#content_home").load("../bin/staff_home.php"); 
}
...
<form action="../bin/processupload.php" method="post" enctype="multipart/form-data" id="MyUploadForm">
