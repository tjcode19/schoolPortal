...
{?>
     <div class="row" id="jokes">
        ...
        <div class="right">
            ...
            <a href="../bin_admin/jokes.php?page=1&act=del&n=<?php echo $log->data['ID']; ?>" class="link-button" title="Delete Joke">D</a>
            <?php 
                if($log->data['Status'] == 1){
            ?>
            <a href="../bin_admin/jokes.php?page=1&act=hide&n=<?php echo $log->data['ID']; ?>" class="link-button red" title="Hide Joke">H</a>
            <?php 
                }else{
            ?>
             <a href="../bin_admin/jokes.php?page=1&act=show&n=<?php echo $log->data['ID']; ?>" class="link-button green" title="Show Joke">S</a>
            <?php } ?>
