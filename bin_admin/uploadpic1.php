...
function afterSuccess()
{
	...
	$('#loading-img').hide(); //hide submit button
        ...
        $("#content_emp").load("../bin_admin/emp_det.php"); 
        $("#content_home").load("../bin_admin/admin_home.php"); 
}
...
<form action="../bin_admin/ch_adm_ppix.php" method="post" enctype="multipart/form-data" id="MyUploadForm">
