    ...
    <table width="100%" cellpadding="10" cellspacing="0" id="det">
         <tr>
            <td colspan="3">
                ...
                <a href="../bin_admin/e_st_det.php?n=<?php echo $log->data['id']; ?>" id="edit">Edit</a>
                 <?php echo (($status == 2)?
                        "<a href=\"../bin_admin/v_st_det.php?a=deactivate&n=". $log->data['id'] ."\" id=\"deactivate\">Deactivate</a>":
                        "<a href=\"../bin_admin/v_st_det.php?a=activate&n=". $log->data['id'] ."\" id=\"activate\">Activate</a>"); ?>
                <a href="../bin_admin/v_st_det.php?a=reset&n=<?php echo $log->data['id']; ?>" id="reset">Reset Password</a>
...
function editpix(id, us){
             //showLoader();
             //var link = this.href; 
               $("#show").load("../bin_admin/uploadpic_stu.php?user=" + us +"&name=" + us +"&id=" + id);
               $("#mwindow").show();
               $("#paging_button").show();
               //hideLoader();
	};
