     ...
     <div id="mai" style="margin-bottom: 10px;">
         <form action="" method="post" id="paylog">
            ...
            <table width="100%" cellpadding="10" cellspacing="0" border="1">
				<tr><th colspan="6">Total Payment for <?php echo $_REQUEST['class']; ?> Students </th></tr>
                <tr><th>S/N</th><th>Depositor</th><th>Amount</th><th>Date</th><th>Time</th><th>Details</th></tr>
                <?php 
                ...
                <tr align='center'>
                    <td><?php echo ($r + 1); ?></td>
					<td><?php
						$name->set_sqlstr("SELECT * FROM student_data WHERE Username ='". $log->data[0] ."'"); 
						$name->querydata();
						echo $name->data[1].", ".$name->data[2]." ".$name->data[3]; ?>
					</td>
               ...
               <?php $log->fetchdata(); }?>
                <tr align='center'>
                    <td colspan="2"><span style="font-size: 26px">Total Payment</span></td>
                    <td colspan="4"><span style="font-size: 24px">
                        <?php 
							 $amtT = 0;
