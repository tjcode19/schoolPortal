    ...
    <table width="100%" cellpadding="10" cellspacing="0" id="det">       
         <tr>
            <td colspan="3">
                ...
                <a href="../bin_admin/v_s_det.php?n=<?php echo $log->data['Username']; ?>" id="edit">View</a>
        ...
        <tr>
            <td></td><td align="right">Post:</td><td><input type="text" name="po" value="<?php echo $po; ?>" size="20" ></td>
        </tr>
        <tr>
   ...
   $('#m').submit(function(e) {
    ...
    $.ajax(
    {
        ...
        success:function(d)
        {
            ...
            $("#content").load("../bin_admin/v_s_det.php?n="+ d, hideLoader());
        },
