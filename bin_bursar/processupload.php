...
if(isset($_POST))
{
	...
	$DestinationDirectory	= '../passport/staff/'; //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '</tr><tr>';
		echo '<td align="center"><img src="../passport/staff/'.$NewImageName.'" alt="Resized Image"></td>';
		echo '</tr>';
		echo '</table>';
		...
		*/
                ...
                $log->set_sqlstr("UPDATE staff_data SET Passport='".$path."', Passport1='".$path1."' WHERE Username = '" . $ImageName . "'");
                $log->ex_scalar();
