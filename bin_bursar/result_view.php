...
<div id=\"container\"> 
    <div id=\"rowth\">
        ...
        <div class=\"rightth\"><a target=\"_blank\" href=\"../Admin_Module/resultpageall.php?&c=". 
            $_REQUEST['c'] ."&se=". $_REQUEST['se'] . "&t=". $_REQUEST['t'] ."\" class=\"link-button\">View Result</a>
			<a target=\"_blank\" href=\"../Admin_Module/printslip.php?&c=". 
            $_REQUEST['c'] ."\" class=\"link-button\">Print Slip</a></div>
    </div> 
    ";
}
?>
...
for($i = 0; $i < $log->no_rec; $i++)
{
    ...
    <div class="row">
           ...
           <div class="right"><a target="_blank" href="../Admin_Module/resultpage.php?&id=<?php echo $log->data[0]; ?>&c=<?php echo $_REQUEST['c']; ?>&se=<?php echo $_REQUEST['se'] ?>&t=<?php echo $_REQUEST['t']; ?>" class="link-button">View Result</a>
		   <a target="_blank" href="../Admin_Module/resultpageEdit.php?&id=<?php echo $log->data[0]; ?>&c=<?php echo $_REQUEST['c']; ?>&se=<?php echo $_REQUEST['se'] ?>&t=<?php echo $_REQUEST['t']; ?>" class="link-button">Delete Result</a></div>
        </div>
