...
{?>
     <div class="row" id="article">
        ...
        <div class="right">
            ...
            <a href="../bin_cpanel/article.php?page=1&act=del&n=<?php echo $log->data['ID']; ?>" class="link-button" title="Delete Article">D</a>
            <?php 
                if($log->data['Status'] == 1){
            ?>
            <a href="../bin_cpanel/article.php?page=1&act=hide&n=<?php echo $log->data['ID']; ?>" class="link-button red" title="Hide Article">H</a>
            <?php 
                }else{
            ?>
             <a href="../bin_cpanel/article.php?page=1&act=show&n=<?php echo $log->data['ID']; ?>" class="link-button green" title="Show Article">S</a>
            <?php } ?>
