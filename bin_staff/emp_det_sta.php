<?php 
    ...
    if(isset($_REQUEST['action'])){
        ...
        $log->set_sqlstr("SELECT * FROM staff_data WHERE Username ='". $_SESSION['s_portal_id'] ."'"); 
        $log->querydata();
...
<table width="100%" cellpadding="10" cellspacing="0">
    <tr>
        <td rowspan="6" width="30%">
            ...
            <?php echo "<input type=\"button\" value=\"Change Profile Picture\" onClick=\"editpix('".$log->data['Username']."');\">"; ?>
        </td>
        <td align="right">Staff ID:</td><td><?php echo $_SESSION['s_portal_id']; ?></td>
    </tr>
    <tr>
