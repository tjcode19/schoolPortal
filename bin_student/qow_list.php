...
if(isset($_REQUEST['a']) && ($_REQUEST['a']=="del")){
        ...
        $log->set_sqlstr("UPDATE quiz_tab SET Status='' WHERE Status = 'Active' AND Session='".$sess."'");
        $log->ex_scalar();
...
?>
             <table width="100%" cellpadding="10" cellspacing="0" id="payrec">
                            ...
                            <tr>
                                <th>S/N</th><th>ID</th><th>Question</th><th>Answer</th><th width="20%"></th>
                            </tr>
<?php
 echo ((isset($m))? $m :"");
...
{?>
           ...
           <tr align="center">
                ...
                <td>
                    <a href="../bin_cpanel/qow_edit.php?n=<?php echo $log->data['ID']; ?>">
                        <img class="alignleft" alt="View" title="View Details" src="../img/mono-icons/paper32.png" />
                    </a>
                    <?php  if($log->data['Status'] != "Used"){ ?>
                        <a href="../bin_cpanel/qow_list.php?page=1&a=show&n=<?php echo $log->data['ID']; ?>">
                            <img class="alignleft" alt="Activate" title="Set Active" src="../img/mono-icons/check32.png" />
                        </a>
                    <?php }else{ ?>
                        <a href="../bin_cpanel/qow_list.php?page=1&a=reset&n=<?php echo $log->data['ID']; ?>">
                            <img class="alignleft" alt="Reset" title="Reset" src="../img/mono-icons/exchange32.png" />
                        </a>
                    <?php } ?>
                    <a href="../bin_cpanel/qow_list.php?page=1&a=del&n=<?php echo $log->data['ID']; ?>">
