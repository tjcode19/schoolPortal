...
for($i = 0; $i < $log->no_rec; $i++)
{
    ...
    <div class="row">
           ...
           <div class="right"><a target="_blank" href="../Admin_Module/resultpage.php?&id=<?php echo $log->data[0]; ?>&c=<?php echo $_REQUEST['c']; ?>&se=<?php echo $_REQUEST['se'] ?>&t=<?php echo $_REQUEST['t']; ?>" class="link-button">View Result</a></div>
        </div>
